...
public class FlightDAO extends DBContext {
    ...
    public void createFlight(Flight Flight) {
        String query = "INSERT INTO Flight (seats, departureTime, source, destination, arrivalTime, price) "
                + "VALUES (?, ?, ?, ?, ?, ?)";
...
"                    [dbo].[Flight].[arrivalTime], [dbo].[Flight].[price]\n" +
"                FROM\n" +
"                    [dbo].[Flight]\n" +
"                LEFT JOIN\n" +
"                    [dbo].[ticket]\n" +
...
"                    [dbo].[Flight].[id];  ";
        try ( PreparedStatement preparedStatement = connection.prepareStatement(query);  ResultSet resultSet = preparedStatement.executeQuery()) {
            while (resultSet.next()) {
                ...
                Flight Flight = new Flight(id, seats, departureTime, source, destination, arrivalTime, price);
                Flightes.add(Flight);
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
        ...
        try ( PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            try ( ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    Flight = new Flight(id, seats, departureTime, source, destination, arrivalTime,price);
                }
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
